<template>
  <div class="gprint">
    ...
    <el-button type="primary" @click="sendQRCode">二维码</el-button>
  </div>
</template>
<script>
import tsc from "@/views/pingge/gprint/utils/tsc.js";
  ...
  methods: {
    ...
    init() {
      this.$axios({
        ...
        //     {
        //       this.currentDeviceName=res.devices[0].name
        //       this.currentDeviceID=res.devices[0].deviceId
        //       wx.createBLEConnection({
        //         // 这里的 deviceId 需要已经通过 createBLEConnection 与对应设备建立链接
        //         deviceId:  this.currentDeviceID,
        //         success: (res=>{
        ...
        //                             characteristics.forEach(characteristic=>
        //                             {
        //                               if(characteristic.properties.write&&characteristic.properties.read&&characteristic.properties.notify&&characteristic.properties.indicate)
        //                               {
        //                                 this.currentServiceID=element.uuid
        //                                 this.currentCharacteristicId=characteristic.uuid
        //                               }
